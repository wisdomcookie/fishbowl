...
public:
    ...
    Profile(int id, QString username, QString password, QString firstName, QString lastName, int age, QString location, QString type, QDateTime dateCreated, QString description);
